...
function App() {
  ...
  return <main>
    <header className="site-header"><a className="brand" href="#reading"><BookOpen size={22} aria-hidden="true" /> Antigua Cognate Reading Task</a><nav aria-label="Main navigation"><a href="#lab">Guessing Task</a><a href="#check">Quick Check</a></nav></header>
    <section className="intro" aria-labelledby="page-title"><h1 id="page-title">Reading Task - Cognates for A2</h1></section>
    ...
    <footer>Antigua Cognate Reading Task</footer>
  </main>
}
